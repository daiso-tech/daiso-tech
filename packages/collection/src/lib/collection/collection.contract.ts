...
export type ICollection<TInput> = Iterable<TInput> & {
     ...
     */
    sum(throwOnNumberLimit?: boolean): number;
     ...
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    average(throwOnNumberLimit?: boolean): number;
     ...
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    median(throwOnNumberLimit?: boolean): number;
     ...
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    medianBigint(throwOnNumberLimit?: boolean): bigint;
