import {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    type NumberOverflowError,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    type NumberUnderflowError,
    type PageSettings,
    type RecordItem,
 ...
 * @throws {NumberOverflowError}
 * @throws {NumberUnderflowError}
...
export type IAsyncCollection<TInput> = AsyncIterable<TInput> & {
     ...
     * @throws {NumberOverflowError} {@link NumberOverflowError}
     * @throws {NumberUnderflowError} {@link NumberUnderflowError}
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    sum(throwOnNumberLimit?: boolean): Promise<number>;
     ...
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    average(throwOnNumberLimit?: boolean): Promise<number>;
     ...
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    median(throwOnNumberLimit?: boolean): Promise<number>;
    ...
    /**
     * The sumBigint method is the same as sum method but it works with bigint type
     * @throws {CollectionError} {@link CollectionError}
     * @throws {UnexpectedCollectionError} {@link UnexpectedCollectionError}
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    ...
    /**
     * The averageBigint method is the same as average method but it works with bigint type
     * @throws {CollectionError} {@link CollectionError}
     * @throws {UnexpectedCollectionError} {@link UnexpectedCollectionError}
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    ...
    /**
     * The medianBigint method is the same as median method but it works with bigint type
     * @throws {CollectionError} {@link CollectionError}
     * @throws {UnexpectedCollectionError} {@link UnexpectedCollectionError}
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    medianBigint(throwOnNumberLimit?: boolean): Promise<bigint>;

    /**
     * The minBigint method is the same as min method but it works with bigint type
     * @throws {CollectionError} {@link CollectionError}
     * @throws {UnexpectedCollectionError} {@link UnexpectedCollectionError}
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
    ...
    /**
     * The maxBigint method is the same as max method but it works with bigint type
     * @throws {CollectionError} {@link CollectionError}
     * @throws {UnexpectedCollectionError} {@link UnexpectedCollectionError}
     * @throws {InvalidTypeError} {@link InvalidTypeError}
     */
